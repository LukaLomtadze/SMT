...
const DropDown = forwardRef(({ email, name, image, isVisible ,opened }, ref) => {
  ...
  return (
    ...
    >
        <div className='flex flex-row w-[248px] items-center p-3 h-[60px] gap-2 border-1 border-b-[#3c3c3c] border-t-0 border-l-0 border-r-0'>
            <img src={image} className='w-[40px] h-[40px] rounded-2xl' />
        ...
        <div className='flex flex-col items-center py-2'>
            <div  onClick={handleLogOut} className='flex flex-row gap-2 cursor-pointer items-center p-3 hover:bg-[#333232] rounded-[10px] w-[230px] h-[40px]'>
