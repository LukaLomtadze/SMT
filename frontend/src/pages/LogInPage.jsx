  ...
  return (
    <div className='w-screen h-screen flex items-center justify-center '>
        <form className='text-white border-0 rounded-2xl' onSubmit={handleSubmit}>
            <div className='flex flex-col items-center  md:justify-between justify-around  pt-3 w-screen h-screen md:w-96 rounded-2xl md:h-[400px] bg-neutral-900'>
                <div className='flex flex-col gap-3 mt-32 md:mt-0 w-80'>
                    ...
                    {error && <p className="text-sm text-red-500 absolute bottom-72">{error}</p>}
                    {isLoading ? <Button label={<AiOutlineLoading3Quarters className="animate-spin mx-auto" />}></Button> : <Button label="Log In" />}
                    <NavLink className={"hover:underline text-center hover:text-blue-300 text-neutral-400"}>Forgot password?</NavLink>
                </div>
